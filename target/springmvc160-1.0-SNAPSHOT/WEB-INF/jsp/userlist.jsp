...
<%--<%--%>
	...
	<%--response.sendRedirect("/user/main.html?method=query");--%>
<%--}--%>
<%--%>--%>
<meta charset="UTF-8">
        <div class="right">
            ...
            <div class="search">
           		<form method="post" action="${pageContext.request.contextPath }/user/queryUserList">
					<input name="method" value="query" class="input-text" type="hidden">
					 ...
					 <a href="${pageContext.request.contextPath}/user/intoUserAdd" >添加用户</a>
				</form>
            </div>
            <!--用户-->
                ...
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${userList }" varStatus="status">
					<tr>
						...
						<td>
							<span>
								<c:out value="${user.gender==1?'男':'女'}"></c:out>
							</span>
						</td>
						<td>
						<span>${user.age}</span>
